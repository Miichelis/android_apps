        ...
        if self.ids.calculator_input.text[-1] != "e":
            ...
            if prior[len(prior) - 2:len(prior)] == "/*" or prior[len(prior) - 2:len(prior)] == "*/":
                ...
                if len(self.ids.calculator_input.text) == 1:
                    ...
                    self.ids.calculator_input.text = prior[0:len(self.ids.calculator_input.text)-1]
    ...
    def plus_minus(self):
        if self.ids.calculator_input.text[-1] != "e":
            ...
            if prior[len(prior)-2:len(prior)] == "/*" or prior[len(prior)-2:len(prior)] == "*/":
                ...
                if not ("*" in self.ids.calculator_input.text or "/" in self.ids.calculator_input.text
                        or "+" in self.ids.calculator_input.text
                        or ("-" in self.ids.calculator_input.text and self.ids.calculator_input.text[0] != "-")):
